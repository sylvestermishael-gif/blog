      ...
      <div className="flex-1 flex flex-col p-8 md:p-24 justify-center relative bg-white dark:bg-slate-950 transition-colors">
        ...
        <div className="max-w-md mx-auto w-full space-y-10">
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center space-x-4 py-5 px-6 border-2 border-slate-100 dark:border-slate-800 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-900 transition-all group shadow-sm dark:shadow-blue-500/5 text-slate-900 dark:text-white"
          >
